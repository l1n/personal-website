<?php
$userpwd = $_GET["user"].':'.$_GET["password"];
$baseurl = 'https://groups.noblejury.com/SOGo/dav/';

header('Content-type: text/calendar; charset=utf-8');
header('Content-Disposition: attachment; filename='.$_GET["id"].'-calendar.ics');

// new cURL-Handle
$ch = curl_init();

// set options
curl_setopt($ch, CURLOPT_URL, $baseurl.$_GET["id"]);
